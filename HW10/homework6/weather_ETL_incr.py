...
with DAG(
    dag_id = 'weather_ETL_incr', # TO DO: add incremental as a suffix to the DAG id
    ...
    CITY = "Fremont"               # TO DO: Set the city name to your coordinates' city name
    
    database = "USER_DB_COBRA"           # TO DO: Set the database name  
    schema = "raw"
